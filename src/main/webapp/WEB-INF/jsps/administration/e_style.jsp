...
<br />
<form name="e_style" onsubmit="return validate_form(e_style)" method="POST" action="<%= response.encodeURL("?action=f_e_style&stylename=" + stylename + "&nav=Admin&view=e_style") %>">
