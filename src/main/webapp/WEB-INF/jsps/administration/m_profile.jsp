...
<table class="mainModuleItem">
  <tr>
    <td class="mainModuleItemTitle">Edit Profile</td>
  </tr>
  <tr>
		...
		try  {
			...
			if(rs.first())  {
				...
				%>
				  ...
				  <tr>
				    <td>*Password:</td>
				    <td><input type="text" name="Password" value="<%= passw %>" maxlength=50></td>
				  </tr>
				  <tr>
				    <td>*Password Again:</td>
				    <td><input type="text" name="Password2" value="<%= passw %>" maxlength=50></td>
				  </tr>
				  <tr>
				  ...
				  <tr>
					...
					<option <% if(act == true) { %> selected=true <% } %> value="true">true</option>
					<option <% if(act == false) { %> selected=true <% } %> value="false">false</option>
					</select>
				    </td>
				  </tr>
				  <tr>
					...
					<option <% if(position.equals("Administrator")) { %> selected=true <% } %> value="Administrator">Administrator</option>
					<option <% if(position.equals("User")) { %> selected=true <% } %> value="User">User</option>
					<option <% if(position.equals("Member")) { %> selected=true <% } %> value="Member">Member</option>
					</select>
				    </td>
				  </tr>
				  <tr>
